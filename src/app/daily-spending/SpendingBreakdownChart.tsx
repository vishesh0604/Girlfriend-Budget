...
function ChartModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md max-h-[calc(100vh-3rem)] overflow-y-auto rounded-3xl border border-[#f3b9cd] bg-[#ffdce9] p-6 shadow-xl"
        style={{
          animation:
            "chart-pop-in 220ms ease-out both",
        }}
      >
